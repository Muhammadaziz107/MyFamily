      ...
      <>
         <section className='our-courses'>
               <div className="courses container">
                  ...
                  <p className='courses__sub-title'>Perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium</p>
...

                     {
                        courses && courses.map((c) => (
                                       <li ref={crsItem} className={`courses-item ${display}`} key={c.id}>
                                          ...
                                          <Link className='courses-item__edit' to={`/course/${c.id}`} onClick={e => {localStorage.setItem("courseId", c.id)}} >Batafsil</Link>
                                       </li>
                                    ))
                     }
                  </ul>
                  <button className='course-list_show-more' onClick={e => {
