      ...
      <>
         <section className='about-author'>
            <div className='author container'>
               ...
               <p className='about-author__description'>Perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium </p>

               <div ref={authorVideo} className='about-author__video'>
                     <img className='video__img' src={authorImgJpg} onClick={(e) => {
                        authorVideo.current.innerHTML = authorVideoLink;
                     }}/>

                     <button className='video__btn' onClick={(e) => {
                        authorVideo.current.innerHTML = authorVideoLink
